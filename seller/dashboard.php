    ...
    -->
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="list_add_products">
            <a href="#" onclick="Ajax_Add_Products()">
...
function Ajax_Products(){
    $.ajax({
        ...
        success: function (result) {
            ...
            $(".list_dashboard,.list_products,.list_add_products,.list_add_category").removeClass("active");
            $(".list_products").addClass("active");
        // setInterval(function(){  filter_data() },5000).fadeoIn(1000);
        }
    });
}
function Ajax_Add_Products(){
    $.ajax({
        url: "Add_Product.php",
        success: function (result) {
            $("#Ajax_Content_Display").html(result);
            $(".list_dashboard,.list_products,.list_add_category").removeClass("active");
            $(".list_add_products").addClass("active");
        // setInterval(function(){  filter_data() },5000).fadeoIn(1000);
        }
    });
}
function Ajax_Add_Category(){
    $.ajax({
        ...
        success: function (result) {
            $("#Ajax_Content_Display").html(result);
            $(".list_dashboard,.list_products,.list_add_products,.list_products").removeClass("active");
...
function add_product(){
  ...
  $(".Ajax_add_product_Responce").html('<img src="../assets/images/loading.gif"> saving...');
  $.ajax({
    type:"POST",
    url:"Back_Scripts.php",
    data:formdata,
