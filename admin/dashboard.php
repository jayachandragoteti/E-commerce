    ...
    -->
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class="dropdown list_users">
            <a href="#" id="dropdownMenuLink" data-toggle="dropdown">
              <i class="fas fa-users"></i>
              <p>Users <small class="fas fa-angle-down"></small></p>
            </a>
              <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <a class="dropdown-item" href="#" onclick="Ajax_City_Admins()">City Admins</a>
                <a class="dropdown-item" href="#" onclick="Ajax_Sellers()">Sellers</a>
                <a class="dropdown-item" href="#" onclick="Ajax_Coustomers()">Coustomers</a>
              </div>
          </li>
          <li class="list_add_city_admin">
            <a href="#" onclick="Ajax_Add_City_Admin()">
...
function Ajax_Products(){
    $.ajax({
        ...
        success: function (result) {
            ...
            $(".list_dashboard,.list_users,.list_add_city_admin,.list_add_category").removeClass("active");
...
function Ajax_City_Admins(){
    $.ajax({
        ...
        success: function (result) {
            $("#Ajax_Content_Display").html(result);
            $(".list_dashboard,.list_products,.list_add_city_admin,.list_add_category").removeClass("active");
...
function Ajax_Add_City_Admin(){
    $.ajax({
        ...
        success: function (result) {
            $("#Ajax_Content_Display").html(result);
            $(".list_dashboard,.list_products,.list_users,.list_add_category").removeClass("active");
            $(".list_add_city_admin").addClass("active");
        // setInterval(function(){  filter_data() },5000).fadeoIn(1000);
        }
    });
}
...
function Ajax_Add_Category(){
    $.ajax({
        ...
        success: function (result) {
            $("#Ajax_Content_Display").html(result);
            $(".list_dashboard,.list_products,.list_users,.list_add_city_admin").removeClass("active");
...
function add_city_admin(){
    ...
    if (formdata.fname !="" && formdata.lname !="" && formdata.email !="" && formdata.phone !="" && formdata.address !="" && formdata.city !="" && formdata.password !="") {
      $.ajax({
        type:"POST",
        url:"Back_Scripts.php",
        data:formdata,
        success:function (responce) {
          $('.Ajax_city_admin_Responce').html(responce);
        }
      });
    }else{
      $('.Ajax_city_admin_Responce').html('*All fields must be filed');
    }
}
...
function CityStatus(cityId) {
  var cityId;
  var cityadminStatus="cityadminStatus";
  $.ajax({
        type:"POST",
        url:"Back_Scripts.php",
        data:{cityId,cityadminStatus},
        success:function (responce) {
          $('.cityadminStatusResponce'+cityId).html(responce);
        }
      });
}
function deltecity(cityId) {
  var cityId;
  var deltecity="deltecity";
  $.ajax({
        type:"POST",
        url:"Back_Scripts.php",
        data:{cityId,deltecity},
        success:function (responce) {
          $('.deltecityResponce'+cityId).html(responce);
        }
      });
}
</script>
