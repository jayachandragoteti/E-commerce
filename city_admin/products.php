...
<div class="row">
    <div class="col-md-12">
        <?PHP 
            $city_admin_sno = $_SESSION['admin']['sno'];
            $select_city="SELECT * FROM `cities` WHERE `cities`.`admin` = '$city_admin_sno'";
            $select_city_result=mysqli_query($connect,$select_city);
            $select_city_row=mysqli_fetch_array($select_city_result);
            $city_sno=$select_city_row['sno'];
            $select_product="SELECT * FROM `products` WHERE `city` = '$city_sno' ";
            ...
            ?>
                <div class="card" style="width:18rem;">
                    <img class="card-img-top" src="../product_images/<?PHP echo $select_product_row['image']; ?>" alt="Card image cap">
                    <div class="card-body">
